...
describe("GET /api/v1/user", () => {
  describe("Default user", () => {
    ...
    test("With nonexistent session session", async () => {
      const nonexistent =
        "0123456789abcdefc7c07d5ee75551ea6b5ffde075b2bcdac42e6b1365f9f9a12adab9fb4b838f0a7bfe0ab1955bfef0";
    ...
    test("With half-expired session", async () => {
      const halfLife = session.EXPIRATION_IN_MILLISECONDS / 2;
      jest.useFakeTimers({
